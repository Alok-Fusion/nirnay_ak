...
import { BankingProductsView } from './components/BankingProductsView';
import { ScamDrillsView } from './components/ScamDrillsView';
...
const AppContent: React.FC = () => {
  ...
  const refetchAllBankingData = () => {
    ...
    queryClient.invalidateQueries({ queryKey: ['securityActivityLog'] });
    refreshUser();
  };
  ...
  return (
    <div className="dashboard-root">
      ...
      <div className="page-container">
        ...
        {activePage === 'drills' && (
          <ScamDrillsView user={user} refetchAllBankingData={refetchAllBankingData} />
        )}

        {/* Active Page: Bank Passbook */}
        {activePage === 'passbook' && (
          <PassbookView passbookData={passbookData} username={user.username} />
        )}

        {/* Active Page: Cards & Deposits */}
        {activePage === 'products' && (
          <BankingProductsView user={user} refetchAllBankingData={refetchAllBankingData} />
        )}
      ...
      <OrchestrationVisualizer
        ...
        setVisualizerOpen={setVisualizerOpen}
        visualizerStep={visualizerStep}
        setVisualizerStep={setVisualizerStep}
        orchTxId={orchTxId}
        orchRiskScore={orchRiskScore}
        orchShapValues={orchShapValues}
        orchAuthStepsRequired={orchAuthStepsRequired}
        orchAuthStepsCompleted={orchAuthStepsCompleted}
        setOrchAuthStepsCompleted={setOrchAuthStepsCompleted}
        orchRequiresClarify={orchRequiresClarify}
        orchClarifyPrompt={orchClarifyPrompt}
        refetchAllBankingData={refetchAllBankingData}
      />
